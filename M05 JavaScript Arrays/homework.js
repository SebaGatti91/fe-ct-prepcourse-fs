...
function empiezaConNueve(num) {
   ...
   const numeroComoString = num.toString(); //paso a string
   return numeroComoString.charAt(0) === '9'; // me fijo en primer caracter
}
...
function todosIguales(array) {
   ...
   const elementoInicial = array[0];

   for (let i = 1; i < array.length; i++) {
     if (array[i] !== elementoInicial) {
       return false;
     }
   }
